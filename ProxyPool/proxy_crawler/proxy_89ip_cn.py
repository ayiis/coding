...
def do(mongodb):
    ...
    print "Job proxy_89ip_cn start at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    ...
    print "Job proxy_89ip_cn done at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
