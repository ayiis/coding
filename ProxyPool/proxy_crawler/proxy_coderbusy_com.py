...
target_page_struct_list = config.crawler_setting["proxy.coderbusy.com"]["target_page_struct_list"]
collection_name = config.crawler_setting["proxy.coderbusy.com"]["collection_name"]
data_source = config.crawler_setting["proxy.coderbusy.com"]["data_source"]
...
def do(mongodb):
    ...
    print "Job proxy_coderbusy_com start at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    ...
    print "Job proxy_coderbusy_com done at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
