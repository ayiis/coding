...
def do(mongodb):
    ...
    print "Job proxy_xicidaili_com start at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
    ...
    print "Job proxy_xicidaili_com done at %s!" % datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S")
