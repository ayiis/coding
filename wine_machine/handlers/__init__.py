...
class ApiHandler(BaseHandler):
    ...
    def post(self):
        ...
        try:
            data, count = yield handler(self, request_data["body"])
            self._send_response(200, {"data": data, "code": 200, "desc": "success", "count": count})
        except Exception as e:
            print(traceback.format_exc())
            self._send_response(200, {"data": None, "code": 500, "desc": str(e), "count": 0})
